...
const onSubmit = async (event) => {
    ...
    formData.append("access_key", "23587f30-5e49-4dd4-83d8-26bdd5cc763a");
  try {
    ...
    (data.success ? toast.success('Thank you for your submission')  :toast.error(data.message));
   event.target.reset();
  ...
  return (
    ...
    id='contact-us' className='relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out to us' desc='From strategy to executiion, we craft digital solutions that move your business forward.'/>
