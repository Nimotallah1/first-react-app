      ...
      <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
        ...
        className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
          ...
          <ul className='flex gap-8'>
            ...
            <li><a className='hover:text-primary' href='#hcontact-us'>Contact Us</a></li>
          </ul>
        </motion.div>
        ...
        className='text-gray-600 dark:text-gray-400'>
          ...
          <div className='flex gap-2 text-sm'>
            <input type='email' placeholder='Enter your email' className='w-full p-3 text-sm outline-none rounded dark:text-gray-200 bg-transparent border border-gray-300 dar:border-gray-500' />
